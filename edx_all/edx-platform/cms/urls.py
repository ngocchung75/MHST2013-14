...
urlpatterns = ('',  # nopep8
    ...
    url(r'^newuser/$', 'contentstore.views.new_user_social', name='new_user_social'),# add new
...
urlpatterns += (url(r'^admin/', include(admin.site.urls)),url(r'', include('social_auth.urls')),)
